...
## Goal  : Project 1 (figure 3) of the Exploratory Data Analysis on Coursera. The goal is to examine how household energy usage varies over a 2-day period in February, 2007
...
legend( "topright", legend = c( "Sub_metering_1", "Sub_metering_2", "Sub_metering_3" ), col = c( "red", "black", "blue" ), lwd=1 )
